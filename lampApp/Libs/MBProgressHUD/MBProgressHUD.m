...
+ (MB_INSTANCETYPE)showHUDAddedTo:(UIView *)view animated:(BOOL)animated {
	...
	return MB_AUTORELEASE(progressHUD);
}
...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opaque = NO;
		self.backgroundColor = [UIColor colorWithRed:0.0f/255.0f green:0.0f/255.0f blue:0.0f/255.0f alpha:0.3];
